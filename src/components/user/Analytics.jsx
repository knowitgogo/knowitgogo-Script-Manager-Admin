...
function Analytics() {
  ...
  const peak = activity.reduce((a, b) => (b.count > a.count ? b : a), {
    count: 0,
    label: "",
  });
    ...
    <div>
      ...
      >
        {[
          ...
          {
            label: "Peak Day",
            value: peak.count ? `${peak.count} on ${peak.label}` : "—",
            accent: "#3b82f6",
          },
      ...
      <div className="admin-card" style={{ padding: "1.5rem" }}>
        ...
        >
          <div>
            ...
            >
              Last 30 days &middot; X axis = Date &middot; Y axis = No. of
              Requests
            </p>
          </div>
          <span
        ...
        {total === 0 ? (
          ...
          >
            ...
            <p style={{ margin: 0 }}>
              No requests recorded in the last 30 days.
            </p>
          </div>
        ) : (
